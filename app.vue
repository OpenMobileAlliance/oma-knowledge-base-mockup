  ...
  <div :class="computedHeightClass" class="w-fit sm:w-full bg-golden/[0.2] dark:bg-[#19191a]"
    ...
    <AppHeader v-if="route.path !== '/'" class="flex py-4" title="OMA">
      <template v-slot:logo>
        <img v-if="computedLogoSrc" src="/logo-dark.png" alt="logo-dark" class="w-fit shrink-0 grow-0 h-16" />
        <img v-if="!computedLogoSrc" src="/logo-light.png" alt="logo-light" class="w-fit shrink-0 grow-0 h-16" />
