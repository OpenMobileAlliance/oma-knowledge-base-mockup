<template>
  <div v-if="data" @click="open" target="_blank" class="tweet">
    <!-- Header -->
    <div class="tweet-header">
      ...
      <div class="tweet-header-name">
        ...
        <!-- Screen Name-->
        <p class="tweet-header-name-bottom">{{ data.userName }}</p>
      </div>
    ...
    <div class="tweet-body">
      <p class="tweet-body-text" v-if="data.sections">
        <span v-for="(item, index) in data.sections" :key="index + 'section'">
          ...
          <!-- URL -->
          <a @click.stop v-else-if="item.name === 'a'" :href="item.href">
            {{ item.text.replace("https://", "") }}
          </a>

          <!-- Hashtag -->
          <a
            @click.stop
            v-else-if="item.name === 'hashtag'"
          ...
          <a
            ...
            :href="`https://twitter.com/${item.text}`"
            target="_blank"
          >
            {{ item.text }}
          </a>
        ...
        <!-- Media (image) -->
        <img
          v-if="props.showMedia && (data.media || data.poster)"
          loading="lazy"
          class="tweet-body-image"
          :src="data.media || data.poster"
        />
      </p>
    </div>
  </div>
...
const { data } = await useFetch<Response>(
  `/api/tweets/${encodeURIComponent(props.id)}`
);
</script>
