export default {
  ...
  teaser: {
    ...
    coverImage: "absolute inset-0 w-full h-full object-cover opacity-60 group-hover:opacity-[10%] transition-opacity duration-500 z-0",
    ...
    coverIcon: "absolute inset-0 w-full h-full object-cover opacity-30 duration-500 group-hover:opacity-[5%] transition-opacity duration-500 z-0",
    image: "relative mt-4 w-full h-auto flex shrink mx-auto z-20",
